...
countries = {
    'Илон Маск': 'Самый богатый человек на земле',
    'Мистер зверь': 'Самый известный Ютуб блогер'
}
...
add_country_button = QPushButton('Добавить')
del_country_button = QPushButton('Удалить')
edit_country_button = QPushButton('Изменить')
...
name_countries.setPlaceholderText('Bыберите...')
